...
-- Trend analysis month and week wise and analyzing patterns 
-- Author Somya Jain
...
ORDER BY 1
;
-- Session volumn on month is generally higher than the weekly average. Also saturday and sunday got the least amount of traffic compared to other days
