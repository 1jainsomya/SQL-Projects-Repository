...
-- Analyzing which channels generate more search and paid and free traffic comparison along with device type traffic distribution
...
-- Q3. Cross Channel big optimization CROSS CHANNEL BID OPTIMIZATION
SELECT
